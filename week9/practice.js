...
const totalBalance=transactions.map((transaction)=>
(transaction.type==='income'?transaction.amount:-transaction.amount))
.reduce((total,current)=>total+current,0)

console.log(`totalBalnce: $${totalBalance}`)

// const sumIncome=transactions.filter((transaction)=>{
//     return transaction.type==='income'
// }
// ).map((transaction)=>transaction.amount).reduce((total,current)=>total+current,0)

// console.log(sumIncome)

// const sumExpense=transactions.filter((transaction)=>
//     transaction.type==='expense').map((transaction)=>
//     transaction.amount).reduce((total,current)=>total+current,0)
